...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "vVhAyY4A#sIDwdH_msqxFdD0IZtSrXsRByBPUU8q0Cn1v9kex_KM", // Add your session id
PREFIX: process.env.PREFIX || "9",
MODE: process.env.MODE || "public",  //public | private | inbox | group
OWNER_NUMBER: process.env.OWNER_NUMBER || "94743710696",
